...
function About() {
  ...
  return (
    <div ref={textRef} className={isVisible ? "drop-in" : ""}>
      <div className="flex flex-col md:flex-row items-center bg-gradient-to-b rounded-2xl from-white/10 to-transparent">
      ...
      {/* Animations & styling for the profile dots */}
      <style jsx>{`
        .drop-in {
